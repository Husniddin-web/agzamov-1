...
export default function AdminTeamEditPage() {
  ...
  useEffect(() => {
    ...
    const fetchMember = async () => {
      ...
      try {
        ...
        setError(err.message || 'Advokat ma’lumotlarini yuklashda xatolik yuz berdi');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Advokatni yangilashda xatolik yuz berdi');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-zinc-500 gap-3">
        ...
        <p className="text-xs uppercase font-mono tracking-widest">Ma’lumotlar yuklanmoqda...</p>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-white tracking-tight uppercase">
              Advokat Ma’lumotlarini Tahrirlash
            </h1>
            <p className="text-xs text-zinc-400">
              Ism-familiya, lavozim, shior va kontakt ma’lumotlarini yangilash
            </p>
          </div>
        </div>
      </div>
                ...
                {uploading ? (
                  ...
                  <>
                    ...
                    <span className="text-xs font-bold text-white uppercase tracking-wider">
                      Yangi rasm tanlash yoki bu yerga tashlash
                    </span>
